...
인터넷 익스플로러 : 자체 표준이 있으며 자신만의 인터페이스를 사용</p>
...
<p><code v-pre>$('#vstar')[0].onmouseover = function(event) {</code></p>
<p>onmouserover 에 대한 이벤트가 발생하면 해당 함수를 불러와서 실행한다.</p>
...
form 엘리먼트의 경우 return false를 호출하여 submit을 막을 수 있다.</p>
